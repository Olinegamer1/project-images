"""
Django settings for project_images project.
...
MIDDLEWARE = [
    ...
    'middleware.database_error.DataBaseErrorMiddleware',
]

ROOT_URLCONF = 'project_images.urls'
...
WSGI_APPLICATION = 'project_images.wsgi.application'
